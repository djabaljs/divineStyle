 ...
 */
final class Version20201202222935 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product_variation_color (product_variation_id INT NOT NULL, color_id INT NOT NULL, INDEX IDX_AEA922B1DC269DB3 (product_variation_id), INDEX IDX_AEA922B17ADA1FB5 (color_id), PRIMARY KEY(product_variation_id, color_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product_variation_length (product_variation_id INT NOT NULL, length_id INT NOT NULL, INDEX IDX_6405B81EDC269DB3 (product_variation_id), INDEX IDX_6405B81E61ED455A (length_id), PRIMARY KEY(product_variation_id, length_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product_variation_product (product_variation_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_C4F9348DC269DB3 (product_variation_id), INDEX IDX_C4F93484584665A (product_id), PRIMARY KEY(product_variation_id, product_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE product_variation DROP product_id, DROP color_id, DROP length_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product_variation ADD product_id INT DEFAULT NULL, ADD color_id INT DEFAULT NULL, ADD length_id INT DEFAULT NULL');
