 ...
 */
final class Version20201110220118 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_90651744DC058279 ON invoice');
        $this->addSql('ALTER TABLE invoice DROP payment_type_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE invoice ADD payment_type_id INT DEFAULT NULL');
