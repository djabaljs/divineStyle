 ...
 */
final class Version20201106113111 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE attribute ADD register_id INT NOT NULL');
        $this->addSql('ALTER TABLE attribute ADD CONSTRAINT FK_FA7AEFFB4976CB7E FOREIGN KEY (register_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_FA7AEFFB4976CB7E ON attribute (register_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE attribute DROP FOREIGN KEY FK_FA7AEFFB4976CB7E');
        $this->addSql('DROP INDEX IDX_FA7AEFFB4976CB7E ON attribute');
        $this->addSql('ALTER TABLE attribute DROP register_id');
    }
}
