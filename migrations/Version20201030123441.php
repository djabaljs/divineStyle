 ...
 */
final class Version20201030123441 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP sale_vat_price, CHANGE product_number quantity INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD sale_vat_price DOUBLE PRECISION NOT NULL, CHANGE quantity product_number INT NOT NULL');
    }
}
