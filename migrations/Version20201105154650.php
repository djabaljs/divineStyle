 ...
 */
final class Version20201105154650 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD buying_price DOUBLE PRECISION NOT NULL, ADD selling_price DOUBLE PRECISION NOT NULL, DROP unit_price, DROP sale_price');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD unit_price DOUBLE PRECISION NOT NULL, ADD sale_price DOUBLE PRECISION NOT NULL, DROP buying_price, DROP selling_price');
    }
}
