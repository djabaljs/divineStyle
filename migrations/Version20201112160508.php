 ...
 */
final class Version20201112160508 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD providers_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE provider DROP FOREIGN KEY FK_92C4739C4584665A');
        $this->addSql('DROP INDEX IDX_92C4739C4584665A ON provider');
        $this->addSql('ALTER TABLE provider DROP product_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product DROP providers_id');
        $this->addSql('ALTER TABLE provider ADD product_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE provider ADD CONSTRAINT FK_92C4739C4584665A FOREIGN KEY (product_id) REFERENCES product (id)');
        $this->addSql('CREATE INDEX IDX_92C4739C4584665A ON provider (product_id)');
    }
}
