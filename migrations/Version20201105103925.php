 ...
 */
final class Version20201105103925 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product DROP INDEX UNIQ_D34A04AD4976CB7E, ADD INDEX IDX_D34A04AD4976CB7E (register_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product DROP INDEX IDX_D34A04AD4976CB7E, ADD UNIQUE INDEX UNIQ_D34A04AD4976CB7E (register_id)');
    }
}
