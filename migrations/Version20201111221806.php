 ...
 */
final class Version20201111221806 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE order_product ADD CONSTRAINT FK_2530ADE6462F07AF FOREIGN KEY (product_order_id) REFERENCES `order` (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE order_product ADD CONSTRAINT FK_2530ADE66C8A81A9 FOREIGN KEY (products_id) REFERENCES product (id) ON DELETE SET NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE order_product DROP FOREIGN KEY FK_2530ADE6462F07AF');
        $this->addSql('ALTER TABLE order_product DROP FOREIGN KEY FK_2530ADE66C8A81A9');
        $this->addSql('ALTER TABLE order_product ADD CONSTRAINT FK_2530ADE6462F07AF FOREIGN KEY (product_order_id) REFERENCES `order` (id) ON DELETE CASCADE');
